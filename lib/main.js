exports.main = function(options) {
	...
	/**
	 * the following method are used when the dropbox is selected by the user 
	 * its uses a Request to Bugzilla Web Services
	 */
	...
	/**
	 * the following method are used when the dropbox is selected by the user 
	 * it's uses a Request to Bugzilla Web Services
	 */
	...
	//Request method for content list when user ask for "Bugmasters Projects"
	...
	/**
	 * the following method is used in the Triage Tab to get the latest 3 UNCONFIRMED BUGS 
	 * it's uses a Request to Bugzilla Web Services
	 */
